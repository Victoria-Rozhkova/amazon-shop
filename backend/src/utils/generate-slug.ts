const translit = (str: string): string => {
	...
	const en =
		"A-a-B-b-V-v-G-g-Ġ-ġ-D-d-E-e-Ė-ė-Ě-ě-ƵH-zh-Ƶ-z-I-i-Ȉ-ȉ-Ȋ-ȋ-J-j-K-k-L-l-M-m-N-n-O-o-P-p-R-r-S-s-T-t-U-u-F-f-H-h-TS-ts-CH-ch-SH-sh-sch-'-'-Y-y-'-'-Ē-ē-YU-yu-YA-ya".split(
			'-'
		)
